...
export {
  PenelopeNarrativeAuthorityTextSchema,
  PenelopeNarrativeDialogueAuthoritySchema,
  PenelopeNarrativeLicensedRenderingDetailSchema,
  PenelopeNarrativePlainDramaticPlanSchema,
  PenelopeNarrativePreflightSchema,
  PenelopeNarrativeReferenceReceiptSchema,
  PenelopeNarrativeSceneAuthoritySchema,
  LicensedRenderingDetailSchema,
  NarrationIdentifierSchema,
  ...
  type PenelopeNarrativeAuthorityText,
  type PenelopeNarrativeDialogueAuthority,
  type PenelopeNarrativeLicensedRenderingDetail,
  type PenelopeNarrativePlainDramaticPlan,
  type PenelopeNarrativePreflight,
  type PenelopeNarrativeReferenceReceipt,
  type PenelopeNarrativeSceneAuthority,
