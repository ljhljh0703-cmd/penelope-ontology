...
| World Workbench | verified on current tree | `/` and `/world` run the Book 19 causal demo with A/B/C, hash-confirmed C execution, The Loom, World Aftermath, World Codex, causal NPC cards, preserved checkpoints, two endings, Fork Compare, World Forge, and candidate-only Fate Frames |
...
| Production browser flow | verified on current tree | the full 44-check Chromium desktop/mobile WebKit suite passes and includes the real Story fixture API path, Book 19 causal flow, World Codex desktop/mobile overflow checks, Oz switch, World Forge, Fate Frame, and creator-owned starter import; route-mocked interaction checks remain separate |
